  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        onClick={() => setShow((v) => !v)}
        className="absolute right-0 top-0 flex h-9 w-9 items-center justify-center text-muted-foreground transition-colors hover:text-foreground focus-visible:outline-none"
        tabIndex={-1}
      >
        {show ? (
