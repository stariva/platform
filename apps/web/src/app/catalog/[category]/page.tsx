      ...
      <main className="min-h-screen bg-parchment pt-[60px] lg:pt-[68px]">
        ...
        {categorySlug === "clothes" && (
          <section className="max-w-5xl mx-auto px-5 pb-12 space-y-4 text-espresso">
            ...
            <p>
              Всю одежду плетём под заказ: в карточке модели выберите
              стандартный размер или нажмите «Заказать по своим меркам» и
              укажите рост, обхват груди, талии и бёдер. Цвет шнура тоже можно
              поменять — мастер согласует детали и цену до начала работы.
              Изготовление занимает 7–21 день.
            </p>
          </section>
        )}
