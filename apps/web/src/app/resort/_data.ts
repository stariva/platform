...
export const advantages: Advantage[] = [
  ...
  },
  {
    ...
    body: "Работаем официально как самозанятые. Договор, счёт, акт выполненных работ и чек НПД — пакет документов для бухгалтерии.",
  },
  {
    number: "06",
...
export const faq: FaqItem[] = [
  ...
  },
  {
    ...
    a: "Минимальный заказ — одно изделие. Скидка 15% — при заказе от 5 изделий. Точную стоимость считаем по брифу — откройте КП или напишите нам.",
  },
];
